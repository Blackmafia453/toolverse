    ...
    <section className="relative overflow-hidden py-24">
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        {search && (
          ...
          <div className="mt-8 overflow-hidden rounded-3xl border border-white/60 bg-white/80 backdrop-blur-xl shadow-2xl">
            ...
            {filteredTools.length > 0 ? (
              ...
              filteredTools.map((tool) => (
                ...
                <Link
                  key={tool.name}
                  href={tool.link}
                  className="group flex items-center justify-between border-b border-slate-100 px-7 py-5 transition hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 last:border-none"
                >
              ...
              <div className="px-6 py-16 text-center">
                ...
                <FiSearch className="mx-auto text-3xl text-indigo-600" />
