      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              <FaBolt />
              100+ Free Online Productivity Tools
            </div>
            ...
            <p
              ...
              "
            >
              <strong>Soupxor</strong> gives you fast, free and
              privacy-focused online tools for everyday tasks. No complicated
              setup, no unnecessary signup—just powerful tools available
              instantly at{" "}
