      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600">
            ...
            Convert PNG images into JPG format quickly while maintaining
        ...
        <section className="rounded-3xl border border-white/60 bg-white/70 p-6 shadow-2xl backdrop-blur-xl md:p-10">
          ...
          <div className="rounded-3xl border-2 border-dashed border-indigo-200 bg-gradient-to-br from-indigo-50 to-purple-50 p-10 text-center">
            ...
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-2xl bg-white text-indigo-600 text-4xl shadow-md">
            ...
            <p className="mt-2 text-gray-600">
              ...
              Select your PNG file and convert it into JPG instantly.
          ...
          {image && (
            ...
            <div className="mt-10 rounded-3xl border bg-white p-6 shadow-lg">
              ...
              <div className="mb-5 flex items-center gap-3">
                ...
                <FaImage className="text-xl text-indigo-600"/>
          ...
          {convertedImage && (
            ...
            <div className="mt-10 rounded-3xl border border-indigo-100 bg-gradient-to-br from-indigo-50 to-purple-50 p-8 text-center">


              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-white text-indigo-600 text-3xl shadow">
              ...
              <p className="mt-2 text-gray-600">
                ...
                Your converted JPG image is ready.
        ...
        <section className="mt-12 grid gap-6 md:grid-cols-3">
          ...
          <div className="rounded-3xl border bg-white/70 p-6 shadow-lg backdrop-blur">
            ...
            <p className="mt-2 text-sm text-gray-600">
              ...
              Convert images instantly directly in your browser.
          ...
          <div className="rounded-3xl border bg-white/70 p-6 shadow-lg backdrop-blur">
            ...
            <p className="mt-2 text-sm text-gray-600">
              ...
              Images stay on your device and are never uploaded.
          ...
          <div className="rounded-3xl border bg-white/70 p-6 shadow-lg backdrop-blur">
            ...
            <p className="mt-2 text-sm text-gray-600">
              ...
              Optimized JPG conversion with great quality.
